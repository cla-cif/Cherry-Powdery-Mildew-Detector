...
def page_project_hypothesis_body():
    ...
    st.info(
        ...
        f"Average Image, Variability Image and Difference between Averages samples are showed in the leaf visualizer tab."
    )
    ...
    # model_perf_softmax = plt.imread(f"readme_images/model_history_softmax.png")
    ...
    st.info(
        ...
        f"less computational power to train. However, feeding a model with an RGB image or convert that image to grayscale "
        f"depends on the nature of the images and the information conveyd by the colour."
    )
    model_perf_rgb = plt.imread(f"readme_images/model_history_rgb.png")
